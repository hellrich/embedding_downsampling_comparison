...
do
        ...
        do_sgns $DIR/$corpus $DIR/sgns/$corpus/ps_dw_v$i 0 0 #classic sgns
        do_sgns $DIR/$corpus $DIR/sgns/$corpus/ws_dw_v$i 1 0
        do_sgns $DIR/$corpus $DIR/sgns/$corpus/ns_dw_v$i 2 0
       
        #weighted window
        do_sgns $DIR/$corpus $DIR/sgns/$corpus/ps_ww_v$i 0 1
        do_sgns $DIR/$corpus $DIR/sgns/$corpus/ws_ww_v$i 1 1
        do_sgns $DIR/$corpus $DIR/sgns/$corpus/ns_ww_v$i 2 1
        
        #uniform window
        do_sgns $DIR/$corpus $DIR/sgns/$corpus/ps_uw_v$i 0 2
        do_sgns $DIR/$corpus $DIR/sgns/$corpus/ws_uw_v$i 1 2
        do_sgns $DIR/$corpus $DIR/sgns/$corpus/ns_uw_v$i 2 2     
done
